...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Compile every public Solar execution header as an isolated Zephyr C++ TU."
    )
    ...
    headers = sorted((include_root / "solar" / "execution").glob("*.hpp"))
    headers.append(include_root / "solar" / "execution.hpp")
    failures = 0

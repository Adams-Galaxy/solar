...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Compile every public Solar Bus header as an isolated Zephyr C++ TU."
    )
    ...
    headers = sorted((include_root / "solar" / "bus").glob("*.hpp"))
    headers.append(include_root / "solar" / "bus.hpp")
    failures = 0

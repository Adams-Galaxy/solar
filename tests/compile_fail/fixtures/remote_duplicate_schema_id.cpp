...
template <> struct solar::remote::Schema<FirstValue>
{
    ...
    using Fields = remote::Fields<Field<1, "value", &FirstValue::value>>;
...
template <> struct solar::remote::Schema<SecondValue>
{
    ...
    using Fields = remote::Fields<Field<1, "value", &SecondValue::value>>;
    static constexpr std::size_t max_encoded_size = 8;
    static constexpr Codec codec = Codec::Cbor;
};
...
using BadArchitecture =
    solar::remote::Architecture<solar::TypeList<FirstValue, SecondValue>,
                                solar::TypeList<FirstData, SecondData>, solar::TypeList<>,

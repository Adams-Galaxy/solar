...
public:
    ...
    void append_hex16(std::uint16_t value)
    {
        constexpr char hex[] = "0123456789ABCDEF";
        append("0x");
        append(hex[(value >> 12U) & 0x0FU]);
        append(hex[(value >> 8U) & 0x0FU]);
...
struct CompactFormat
{
    static std::size_t format(Record const &record, char *out, std::size_t capacity)
    {
        ...
        writer.append('[');
        writer.append(to_string(record.level));
        writer.append("] ");
        writer.append(record.source != nullptr ? record.source : "?");
        if (record.category != nullptr && record.category[0] != '\0')
        {
            writer.append('/');
            writer.append(record.category);
        }
        writer.append(": ");
        writer.append(record.message != nullptr ? record.message : "");
        writer.append('\n');
...
struct KeyValueFormat
{
    static std::size_t format(Record const &record, char *out, std::size_t capacity)
    {
        ...
        writer.append(record.source != nullptr ? record.source : "?");
        writer.append(" cat=");
        writer.append(record.category != nullptr && record.category[0] != '\0' ? record.category : "none");
        writer.append(" id=");
        writer.append_hex16(record.id);
        writer.append(' ');
        writer.append(record.message != nullptr ? record.message : "");
        writer.append('\n');
        return writer.finish();
...
struct JsonLinesFormat
{
    static std::size_t format(Record const &record, char *out, std::size_t capacity)
    {
        ...
        writer.append_u64(record.timestamp_us);
        writer.append(",\"level\":");
        detail::append_json_string(writer, to_string(record.level));
        writer.append(",\"source\":");
        detail::append_json_string(writer, record.source != nullptr ? record.source : "?");
        writer.append(",\"category\":");
        detail::append_json_string(writer, record.category != nullptr ? record.category : "");
        writer.append(",\"id\":");
        writer.append_u64(record.id);
        writer.append(",\"message\":");
        detail::append_json_string(writer, record.message != nullptr ? record.message : "");
        writer.append("}\n");
        return writer.finish();
    }
};
